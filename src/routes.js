...
routes.post('/sendMail', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, transporter, sender, resSendMail;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, transporter = _a.transporter, sender = _a.sender;
                return [4 /*yield*/, sendMail_1.default(transporter, sender)];
            case 1:
                resSendMail = _b.sent();
